...
import { getAvatarUrl, getPostExpiryLabel, handleAvatarError, isPostExpired } from "../../utils";
import { CATEGORY_COLORS } from "../../lib/postConstants";
      ...
      <header className="flex items-center justify-between gap-3">
        ...
        {post.author ? (
          <div className="flex min-w-0 items-center gap-2">
            ...
            {post?.author?.trustscore != null && (
              <span className="shrink-0 text-[9px] text-zinc-500 flex flex-row gap-2">
